...
public class ResourcePackCoverWidget extends IconWidget {
  ...
  protected ResourcePackCoverWidget(Icon icon, ComponentWidget sizeWidget) {
    super(icon);

    this.containerWidget = new ResourcePackCoverInfoWidget(sizeWidget).addId("cover-info");
  }
